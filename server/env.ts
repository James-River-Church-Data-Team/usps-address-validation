...
const uspsClientIDs = parseStringOrStringArrayEnvVar("USPS_CLIENT_ID");
const uspsClientSecrets = parseStringOrStringArrayEnvVar("USPS_CLIENT_SECRET");
...
export const USPS_CLIENT_ID     = uspsClientIDs!;
export const USPS_CLIENT_SECRET = uspsClientSecrets!;
